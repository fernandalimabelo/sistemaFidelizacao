                        ...
                        <div class="table-responsive">
                            <table class="table table-hover">
                                ...
                                <tbody>
                                    ...
                                    <tr>
                                        <td id="center">{{$produto->id_produto}}</td>
                                        <td title="nome_produto">{{$produto->nome_produto}}</td>
                                        <td title="pontos_produto">{{$produto->pontos_produto}}</td>
                                        <td title="preco">{{$produto->preco_produto}}</td>
                                        <!-- <td id="center">
                                            <a href="{{route('product.edit', $produto->id_produto)}}" 
                                               data-toggle="tooltip" 
                                               data-placement="top"
                                               title="Alterar"><i class="fa fa-pencil"></i></a>
                                            &nbsp;<form style="display: inline-block;" method="POST" 
                                                        action="{{route('product.destroy', $produto->id_produto)}}"                                                        
