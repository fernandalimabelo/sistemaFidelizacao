                            ...
                            <div class="collapse navbar-collapse" id="fancyNav">
                                ...
                                <li class="nav-item dropdown">
                                    ...
                                    <li class="nav-item dropdown">
                                        ...
                                        <div class="dropdown-menu" aria-labelledby="navbarDropdown">
                                            <a href="{{ route('viewRegisterEmpresa') }}"><label class='open-modal dropdown-item text-info'><i class="fas fa-building"></i> Empresas</label></a>
                                            <a href="{{ route('viewRegisterUser') }}"><label for='modal-trigger-center-cadastrarCli' class='open-modal dropdown-item text-success'><i class="fa fa-users" aria-hidden="true"></i> Clientes</label></a>
                                        </div>
                                    </li>
